...
function writeIfAbsent(filePath: string, content: string, force = false): boolean {
...
const ROUTE_WRAPPER = `import { createLinkHandlers } from 'fake-jarvis-external-link-cms';
...
const ROUTE_WRAPPER_ID = `import { createLinkHandlers } from 'fake-jarvis-external-link-cms';
import { createModel } from 'fake-jarvis-external-link-cms';
import { createService } from 'fake-jarvis-external-link-cms';
...
const ROUTE_WRAPPER_CHECK = `import { createLinkHandlers } from 'fake-jarvis-external-link-cms';
import { createModel } from 'fake-jarvis-external-link-cms';
import { createService } from 'fake-jarvis-external-link-cms';
...
const ADMIN_LIST_PAGE = `import { LinkTablePage } from 'fake-jarvis-external-link-cms/admin';
import { createModel } from 'fake-jarvis-external-link-cms';
import { createService } from 'fake-jarvis-external-link-cms';
...
const ADMIN_ADD_PAGE = `import { LinkFormPage } from 'fake-jarvis-external-link-cms/admin';
import { createModel } from 'fake-jarvis-external-link-cms';
import { createService } from 'fake-jarvis-external-link-cms';
...
const ADMIN_EDIT_PAGE = `import { LinkFormPage } from 'fake-jarvis-external-link-cms/admin';
import { createModel } from 'fake-jarvis-external-link-cms';
import { createService } from 'fake-jarvis-external-link-cms';
...
const ADMIN_CHECK_PAGE = `import { LinkCheckPage } from 'fake-jarvis-external-link-cms/admin';
import { createModel } from 'fake-jarvis-external-link-cms';
import { createService } from 'fake-jarvis-external-link-cms';
