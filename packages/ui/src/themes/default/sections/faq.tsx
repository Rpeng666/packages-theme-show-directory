...
/**
 * Default (shadcn) FAQ — single-open accordion over the section's items, with
 * the section tip rendered as an HTML footnote. Ported from the app's default
 * block so the markup lives in the registry; the app block forwards through
 * resolveSection('Faq').
 */
