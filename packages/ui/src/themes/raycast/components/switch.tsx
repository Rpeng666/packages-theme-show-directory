...
/**
 * WorkbenchSwitch — ray.so 风格开关（radix）。复刻 app @/components/switch，
 * 供工作台控件（Background/Dark mode/Line numbers）复用。
 */
type WorkbenchSwitchProps = React.ComponentPropsWithoutRef<typeof SwitchPrimitives.Root> & {
  color?: 'blue' | 'purple'
}

export const WorkbenchSwitch = React.forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, WorkbenchSwitchProps>(
...
WorkbenchSwitch.displayName = 'WorkbenchSwitch'
