...
import { ConsoleLink, useConsoleBridge } from './bridge';
...
import { Nav } from '../../contracts/features/common';
...
export function ConsoleLayout({
  ...
  const { pathname: bridgedPathname } = useConsoleBridge();
  const pathname = bridgedPathname ?? nextPathname;
