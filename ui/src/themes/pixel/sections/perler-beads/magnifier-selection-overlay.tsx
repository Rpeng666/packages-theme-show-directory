...
export interface PerlerMagnifierSelectionOverlayProps {
  isActive: boolean;
...
const MagnifierSelectionOverlay: React.FC<PerlerMagnifierSelectionOverlayProps> = ({
  isActive,
  canvasRef,
  gridDimensions,
  onSelectionComplete
...
export { MagnifierSelectionOverlay }; 