...
const PixelatedPreviewCanvas: React.FC<PerlerPixelatedPreviewCanvasProps> = ({
  mappedPixelData,
  gridDimensions,
  ...
  return (
    <canvas
      ...
      className={`border border-foreground/20 max-w-full h-auto rounded block ${
