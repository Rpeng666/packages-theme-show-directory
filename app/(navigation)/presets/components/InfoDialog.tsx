    ...
    <WorkbenchInfoDialog
      description={
        <>
          ...
          <p>
            Open a preset and click the “Add to Raycast” button to import the preset directly into Raycast. You can also
            download the preset as a JSON file, or copy the URL to share with others.
          </p>
      ...
      shortcuts={shortcuts}
      footerSlot={<SocialFooter referral="presets" />}
    />
  );
}
